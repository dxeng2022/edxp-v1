...
function DrawCloud() {
  ...
  return (
    <div className="drawcloud_box">

      <div className="drawcloud_back" onClick={() => { navigate(-1) }}> 나가기 </div>

      <div className='drawcloud_left'>
        <div className="drawcloud_title">도면 데이터 관리</div>
        <div className="drawcloud_folder">{renderFolderTree(folders)}</div>
      </div>


      <div className='drawcloud_right'>


        <div className='drawcloud_currentPath'>
          현재 폴더 위치 : {currentPath}
          <img src="/img/back.png" alt="img" className="drawcloud_goback" onClick={() => handleGoBack()} />
        </div>

        <div className='drawcloud_buttons'>
        ...
        <div className='drawcloud_list'>
          ...
          <span className='drawcloud_warning'> * 5MB 초과, 파일 5개 이상 불가 </span>
