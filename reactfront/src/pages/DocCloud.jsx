...
function DocCloud() {
  ...
  const [currentPath, setCurrentPath] = useState("doc/");
  ...
  return (
    <div className="doccloud_box">
      ...
      <div className='doccloud_right'>


        <div className='doccloud_currentPath'>
          현재 폴더 위치 : {currentPath}
          <img src="/img/back.png" alt="img" className="doccloud_goback" onClick={() => handleGoBack()} />
        </div>

        <div className='doccloud_buttons'>
        ...
        <div className='doccloud_list'>
          ...
          <span className='doccloud_warning'> * 5MB 초과, 파일 5개 이상 불가 </span>
